...
const protocols = [
  { id: "IACUC-2026-0142", title: "Neurobehavioral Effects of Chronic Stress in C57BL/6 Mice", pi: "Dr. Elena Marsh", species: "Mouse", status: "IACUC Review", animals: 240, pain_category: "Category D", submitted: "2026-06-30", expires: null, review_method: "DMR", pi_proxy: "Sam Whitfield", ptm_member: "Dr. Priya Nair", protocol_type: "Research", anesthesia_required: 1, housing: "Group-housed 5/cage in ventilated cages on a 12:12 light cycle.", disposal: "Carbon dioxide euthanasia; carcasses incinerated per SOP.", npg: "None", research_steps: [
        { description: "Habituate mice to handling for 7 days.", duration: "7 days", frequency: "Daily", species: "Mouse", pain_category: "Category B", anesthesia: "No", location: "Behavior suite, vivarium", personnel: "Dr. Elena Marsh", notes: "" },
  ...
  { id: "IACUC-2026-0150", title: "Deep Brain Stimulation in a Rat Model of Parkinson's Disease", pi: "Dr. Priya Nair", species: "Rat", status: "IACUC Review", animals: 120, pain_category: "Category D", submitted: "2026-05-10", expires: null, review_method: "FCR", pi_proxy: "Dr. Elena Marsh", ptm_member: "Dr. Harold Kim", protocol_type: "Research", anesthesia_required: 1, housing: "Rat housing, 2/cage, enriched with nesting material and a red hut.", disposal: "Pentobarbital overdose, tissue harvested for histology, remaining carcass incinerated.", npg: "None", research_steps: [
        { description: "Stereotaxically implant bilateral DBS electrodes into the subthalamic nucleus.", duration: "~90 min surgery", frequency: "Once", species: "Rat", pain_category: "Category D", anesthesia: "Yes", location: "Surgical suite B", personnel: "Dr. Priya Nair", notes: "Survival surgery with pre- and post-op analgesia." },
        { description: "Deliver 4 weeks of high-frequency stimulation with weekly motor scoring.", duration: "4 weeks", frequency: "Weekly", species: "Rat", pain_category: "Category C", anesthesia: "No", location: "Behavior suite", personnel: "Dr. Priya Nair, Dr. Harold Kim", notes: "Animals are briefly restrained during stimulation sessions." },
        { description: "Assess dopamine neuron survival and gliosis by immunohistochemistry.", duration: "~1 week processing", frequency: "Once", species: "Rat", pain_category: "Category E", anesthesia: "No", location: "Histology lab", personnel: "Dr. Elena Marsh", notes: "" },
  ...
  { id: "IACUC-2026-0147", title: "Adoptive Cell Therapy Against Murine Melanoma", pi: "Dr. Harold Kim", species: "Mouse", status: "Veterinary Review", animals: 200, pain_category: "Category D", submitted: "2026-06-01", expires: null, review_method: "FCR", pi_proxy: "Sam Whitfield", ptm_member: "Dr. Priya Nair", protocol_type: "Research", anesthesia_required: 1, housing: "Immunodeficient mice housed in sterile ventilated cages with autoclaved feed and bedding.", disposal: "CO2 euthanasia followed by cervical dislocation; carcasses incinerated.", npg: "None", research_steps: [
        { description: "Inject B16-F10 melanoma cells subcutaneously and allow tumors to establish.", duration: "~14 days", frequency: "Once", species: "Mouse", pain_category: "Category D", anesthesia: "Yes", location: "Procedure room", personnel: "Dr. Harold Kim", notes: "Isoflurane induction for injection." },
        { description: "Administer CAR-T cells intravenously in the treatment arm.", duration: "~15 min per infusion", frequency: "Once", species: "Mouse", pain_category: "Category D", anesthesia: "No", location: "Procedure room", personnel: "Sam Whitfield", notes: "" },
        { description: "Monitor tumor burden by caliper and ultrasound; collect tumors and spleen for flow cytometry.", duration: "5 weeks", frequency: "As needed", species: "Mouse", pain_category: "Category D", anesthesia: "Yes", location: "Imaging core / necropsy", personnel: "Dr. Harold Kim, Jordan Blake", notes: "Humane endpoint: tumor diameter <= 20 mm." },
      ], purpose_summary: "Test whether engineered immune cells (CAR-T) can eliminate established melanoma tumors in a mouse model of the disease.", harm_benefit_analysis: "Tumor-bearing mice experience the disease burden inherent to a cancer model, with humane endpoints capping tumor size. The benefit is informing next-generation adoptive cell therapies for melanoma patients.", scientific_summary: "Evaluate CAR-T cell efficacy against established subcutaneous B16-F10 melanoma in NOD scid gamma mice. Aims: (1) tumor growth kinetics; (2) CAR-T persistence and infiltration by flow cytometry; (3) survival analysis. Positive results would support progression to syngeneic models." },
  ...
  { id: "IACUC-2026-0155", title: "Corneal Transplantation Techniques in Rabbits", pi: "Dr. Wen Liu", species: "Rabbit", status: "Submitted", animals: 60, pain_category: "Category C", submitted: "2026-07-20", expires: null, pi_proxy: "Dr. Amara Osei", ptm_member: "Dr. Harold Kim", protocol_type: "Research", anesthesia_required: 1, housing: "Rabbits individually housed in standard caging with ad libitum food and water, enriched with chew toys.", disposal: "Euthanized with pentobarbital; corneas harvested, carcasses incinerated.", npg: "None", research_steps: [
        { description: "Perform penetrating keratoplasty with donor corneal grafts.", duration: "~75 min surgery", frequency: "Once", species: "Rabbit", pain_category: "Category D", anesthesia: "Yes", location: "Surgical suite A", personnel: "Dr. Wen Liu", notes: "Survival surgery under general anesthesia with post-op analgesia." },
