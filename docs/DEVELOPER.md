...
Everything technical that used to live in the README moved here, so the
README stays readable for the IACUC researchers and research-administration
staff who use the product. This guide is for people who run, build, or
deploy the code.
...
The full API surface (with the Swagger UI to explore it) is available at
